...
export default function Index({ auth, model, queryParams = null }) {
    ...
    const resourceName = "Paluwagan Category";
    ...
    const onDialogConfig = (config) => {
        setDialogConfig(config || { open: false, process: "", data: null });
    };
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-2xl text-gray-800 dark:text-gray-200 leading-tight">{titleCase(resourceName)}</h2>}
        >
            ...
            <div className="py-12">
                                ...
                                <table className="w-full text-sm bg-gray-100 dark:bg-gray-700">
                                    <thead>
                                        <tr className="text-left border-b border-gray-200 dark:border-gray-600">
                                            <th onClick={() => sortChanged("name")} className="px-4 py-2 text-gray-600 dark:text-gray-300 cursor-pointer">
                                            ...
                                            <th onClick={() => sortChanged("created_at")} className="px-4 py-2 text-gray-600 dark:text-gray-300 cursor-pointer">
                                                <div className="flex items-center gap-1">
                                                    Date Created
                ...
                <Dialog open={dialogConfig.open} onOpenChange={onDialogConfig}>
                    <DialogContent className="sm:max-w-[600px] dark:bg-gray-800 text-gray-900 dark:text-gray-100 dark:border-none">
                        ...
                        {dialogConfig.process === "update" && <Update model={dialogConfig.data} onDialogConfig={onDialogConfig} params={queryParams} />}
